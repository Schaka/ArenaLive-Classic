...
Spell({ 401859, 401863 }, {duration = 30, type = "BUFF", buffType = "Magic" }) -- Prayer of Mending
...
Spell( 407988, { duration = INFINITY, type = "BUFF" }) -- Savage Roar
...
Spell( {402927} , { duration = INFINITY, type = "BUFF" }) -- Victory Rush
...
Spell({ 17941 }, { duration = 10, type = "BUFF", buffType = "Magic" }) -- Shadow Trance
Spell({ 19397 }, { duration = 10, type = "BUFF", buffType = "Magic" }) -- Incinerate
Spell({ 425463 }, { duration = 6 })  -- Demonic Grace
Spell({ 403789 }, { duration = INFINITY })  -- Metamorphosis
...
Spell({ 408510, 408511, 409941}, { duration = 600, type = "BUFF", buffType = "Magic" }) -- Water Shield
Spell({ 408514, 408519 }, { duration = 600, type = "BUFF", buffType = "Magic" }) -- Earth Shield
...
Spell({ 408524, 408525, 409943 }, { duration = 15, type = "BUFF" }) -- Shield Mastery
...
Spell( {408531, 408680, 409955} ,{ duration = INFINITY }) -- Way of Earth
Spell( {425336}, { duration = 15 }) -- Shamanistic Rage
...
Spell({ 425600 }, { duration = 30, type = "BUFF", buffType = "Magic" }) -- Horn of Lordaeron
...
Spell({ 407804 }, { type = "BUFF", duration = 10}) -- Divine Sacrifice
Spell({ 407613, 407615 }, { type = "BUFF", duration = 60}) -- Beacon of Light
...
Spell({ 6150 }, { duration = 12, type = "BUFF" }) -- Quick Shots
...
Spell(400669, { duration = 15, type = "BUFF", buffType = "Magic" }) -- Fingers of Frost
Spell(425121, { duration = 20, type = "BUFF", buffType = "Magic" }) -- Icy Veins
Spell(401417, { duration = 3, type = "BUFF", buffType = "Magic" }) -- Regeneration

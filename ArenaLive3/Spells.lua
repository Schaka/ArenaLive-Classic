...
ArenaLive.spellDB = {
    ...
    ["CCIndicator"] = { -- This table is used to track those spells, that are shown on the Class Portrait's position.
        ...
        [407988] = "usefulBuffs", -- Savage Roar
        ...
        [400735] = "usefulBuffs", -- Temporal Beacon
        [401556] = "usefulDebuffs", -- Living Flame
        [400613] = "usefulDebuffs", -- Living Bomb
        ...
        [408514] = "usefulBuffs", -- Earth Shield
        [8178] = "defCD", -- Grounding Totem
        [425336] = "defCD", -- Shamanistic Rage
        ...
        [403650] = "usefulDebuffs", -- Lake of Fire
        [19397] = "usefulBuffs", -- Incinerate
    ...
    ["Interrupts"] = {
        ...
        ["DRUID"] = { 410176, 10, false }, -- Skull Bash
        ["HUNTER"] = { 34490, 20, false }, -- Silencing Shot
        ["MAGE"] = { 2139, 30, false }, -- Counter Spell
        ["PALADIN"] = { 425609, 10, false }, -- Rebuke
        ["PRIEST"] = { 402174, 12, false }, -- Penance
        ["ROGUE"] = { 1766, 10, false }, -- Kick
        ["WARRIOR"] = { 6554, 10, false }, -- Pummel
        ["SHAMAN"] = { 8042, 6, false }, -- Earth Shock
        ["WARLOCK"] = { 19647, 30, false }, -- Spell Lock
    },
    ...
    ["DefensiveCooldowns"] = {
        ...
        ["PRIEST"] = {
            [425207] = 180, -- Power Word: Barrier
        },
        ["ROGUE"] = {
            [5277] = 300, -- Evasion
        },
        ["SHAMAN"] = {
            [425336] = 60, -- Shamanistic Rage
        },
        ["WARRIOR"] = {
            [871] = 3600, -- Shield Wall
        },
        ["WARLOCK"] = {
            [104773] = 180, -- Unending Resolve
        },
